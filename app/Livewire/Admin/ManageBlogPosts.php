...
class ManageBlogPosts extends Component
{
    ...
    public string $title = '';
    public string $slug = '';
    public string $category = 'Дневник депутата';
    ...
    public function save(): void
    {
        ...
        BlogPost::updateOrCreate(['id' => $this->editingId], [
            'user_id' => auth()->id(),
            'title' => $data['title'],
    ...
    public function resetForm(): void
    {
        ...
        $this->category = 'Дневник депутата';
        $this->status = 'draft';
        $this->isPinned = false;
    }
    ...
    {
        return view('livewire.admin.manage-blog-posts', ['posts' => BlogPost::latest()->paginate(10)]);
    }
}
